...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Community Environmental Justice Tracker";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "environmental_justice_case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "environmental_justice_case_records";
'use strict';
